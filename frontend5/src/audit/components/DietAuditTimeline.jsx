...
import { Box, Typography, Card, Divider, useTheme, Fade } from '@mui/material';
            ...
            <Box sx={{ position: 'relative', pl: { xs: 2, md: 8 } }}>
              ...
              <Box
                sx={{
                  ...
                  width: '3px',
                  background:
                    'linear-gradient(180deg, rgba(76, 175, 80, 0.6) 0%, rgba(76, 175, 80, 0.1) 100%)',
                  borderRadius: '2px',
                }}
              />
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {dateRevisions.map((revision, index) => {
                  ...
                  return (
                    <Fade in={true} timeout={500 + index * 150} key={revision.revisionNumber}>
                      <Box
                        sx={{
                          position: 'relative',
                          pl: { xs: 3, md: 4 },

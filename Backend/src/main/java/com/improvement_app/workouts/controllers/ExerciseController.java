...
//    public ListResponse<ExerciseEntity> getExercisesByDate(@PathVariable String exerciseDate) {
//        List<ExerciseEntity> exercises = exerciseService.findByDateOrderByIndex(LocalDate.parse(exerciseDate));
//

...
public enum ExerciseName {
    ...
    WYCISKANIE_SZTANGI_NA_LAWCE_SKOŚNEJ_RAMPA("Wyciskanie sztangi na ławce skośnej - rampa"),
    WYCISKANIE_SZTANGI_NA_LAWCE_WĄSKO("Wyciskanie sztangi na ławce wąsko"),
    WYCISKANIE_HANTLI_NAD_GŁOWĘ("Wyciskanie hantli nad głowę"),
    FRANCUSKIE_WYCISKANIE_SZTANGI_SIEDZĄC("Francuskie wyciskanie sztangi łamanej siedząc"),
    KRAUL("Kraul"),
    ROWER("Rower"),
